...
- [飞书机器人主动私聊的跨组织前提](飞书机器人主动私聊的跨组织前提.md)：2026-09-07 生产实测——机器人无法向从未与它对话过的跨组织用户发起单聊（`230013`），13 次尝试的正反对照、逐条排除的七个假设、`open_id`/`user_id`/`union_id` 的隔离范围，以及已验明可用的 AppLink 触达办法。
