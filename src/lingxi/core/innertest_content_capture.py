...
from lingxi.core.content_redaction import (
...
# 脱敏纯函数已搬到 core/content_redaction.py 与问答留存语料共用；这里保留原名再导出，
# 既有调用方与用例不必改动。
_redact_json = redact_json
_stringify = stringify_tool_result
_truncate = truncate_summary
__all__ = [
    "MAX_TOOL_RESULT_SUMMARY_BYTES",
    "CapturedToolCall",
